    ...
    <div class="container">
      ...
      <div class="row text-center">
        <div class="col-md-4">
          ...
          <p class="text-muted" align="LEFT">กองทุนส่วนบุคคลโดยมีโบรกเกอร์เป็นตัวกลาง(Pamm)
            โดย จะใช้ระบบทำกำไรแบบ Arbitrage ในตลาด Forex ซึ่งมีความเสี่ยงระดับกลาง
            โดยเฉลี่ยอาจจะได้มากกว่าหรือน้อยกว่าแล้วแต่สภาวะตลาด โดยมีการแบ่งผลกำไร
            กันระหว่างผู้บริหารกองทุนและผู้ลงทุนเป็นอัตราส่วน 30 70 เปิด รับนักลงทุนขั้นต่ำ
            1000$ ขึ้นไป แล้วจะเปิดรับทุกวันที่ 1-5 ของเดือน</p>
        </div>
        <div class="col-md-4">
          <span class="fa-stack fa-4x">
            <i class="fas fa-circle fa-stack-2x text-primary"></i>
          ...
          <p class="text-muted" align="LEFT">Straighttons E fund เป็นการเทรด system trade
            แบบประยุกต์ เป็นการผสมระหว่างคนกับ EA กึ่งอัตโนมัติ โดยไม่ใช่ Martingale
            แบ่งผลกำไร กันระหว่างผู้บริหารกองทุนและผู้ลงทุนเป็นอัตราส่วน 75 : 25
            (แบ่งตามผลกำไร) *กำไร Straighttons E Fund จะปันผลทันทีเมื่อกำไรครบ 10% ซึ่งใน 1
            เดือนจะปันผลมากกว่าหรือน้อยกว่า 1 ครั้ง ขึ้นอยู่กับสภาวะการตลาดของแต่ละเดือน
            ลงทุนขั้นต่ำ 300$
          </p>
        </div>
        <div class="col-md-4">
          ...
          <p class="text-muted" align="LEFT">ความเสี่ยงระดับการป้องกันความเสี่ยงโดยการ
            hedge เงินปันผลกำไรจากทองคำทุกเดือนอย่างสม่ำเสมอ เปิดรับ 21-25 ของทุกเดือน
            อย่าพลาดทำกำไรจากทองคำในช่วงราคาตกต่ำกับมืออาชีพ โดยมีการแบ่งผลกำไร
            กันระหว่างผู้บริหารกองทุนและผู้ลงทุนเป็นอัตราส่วน 30 70 เปิด รับนักลงทุนขั้นต่ำ
            1000$ ขึ้นไป ผลงานจาก Signal ทองคำในห้องขุดทอง และ Uag signal เป็นตัวการันตี
            ห้ามพลาด
          </p>
        </div>
        <div class="col-md-4">
          ...
          <p class="text-muted" align="LEFT">กองทุนส่วนบุคคลโดยมีโบรกเกอร์เป็นตัวกลาง(Pamm)
            โดย จะใช้ระบบทำกำไรจาก Event และข่าว ในตลาด Forex
            ซึ่งมีความเสี่ยงระดับกลางค่อนสูง โดยมีการแบ่งผลกำไร
            กันระหว่างผู้บริหารกองทุนและผู้ลงทุนเป็นอัตราส่วน 30 70 เปิด รับนักลงทุนขั้นต่ำ
            1000$ ขึ้นไป แล้วจะเปิดรับทุกวันที่ 11-15 ของเดือน</p>
        </div>
        <div class="col-md-4">
          <span class="fa-stack fa-4x">
            <i class="fas fa-circle fa-stack-2x text-primary"></i>
          ...
          <p class="text-muted" align="LEFT">
            กองทุนส่วนบุคคลโดยมีโบรกเกอร์เป็นตัวกลาง (Pamm) ซึ่งจะใช้กลยุทธ Arbitrage
            เเบบดั้งเดิมและ Corelation Trade ในการเทรด ซึ่งจะมีข้อดีก็คือความเสี่ยงต่ำกว่า
            เเละมีโอกาส Maximum Drawdown ต่ำกว่า เเละมีโอกาส Order ว่างมากกว่า ของกอง
            StraighttonsArbitrageFund กองเดิมโดยมีการแบ่งผลกำไร
            กันระหว่างผู้บริหารกองทุนและผู้ลงทุนเป็นอัตราส่วน 30 70 เปิด รับนักลงทุนขั้นต่ำ
            1000$ ขึ้นไป แล้วจะเปิดรับทุกวันที่ 11-15 ของเดือน</p>
        </div>
      </div>
